...
<figure><img src="../../.gitbook/assets/0p4LMMOhAN1MANYf9" alt="" height="438" width="700"><figcaption><p>Photo by <a href="https://unsplash.com/@rubaitulazad?utm_source=medium&#x26;utm_medium=referral">Rubaitul Azad</a> on <a href="https://unsplash.com/?utm_source=medium&#x26;utm_medium=referral">Unsplash</a></p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/1CravKadQW6UKyEwqvleVFg.png" alt="" height="217" width="452"><figcaption><p>Docker architecture</p></figcaption></figure>
...
{% hint style="info" %}
For Windows 10 Home, you’ll need to install Docker Toolbox instead, which uses VirtualBox to run Docker.
{% endhint %}
...
{% hint style="info" %}
You can’t remove a running container unless you use the `-f` (force) option.
{% endhint %}
...
{% hint style="info" %}
You need to be logged in to Docker Hub (`docker login`) before pushing.
{% endhint %}
...
3.  Limit memory and enable swapping:
...
{% step %}
Now, the `web` container can communicate with the `db` container using the hostname `db`.
{% endstep %}
{% endstepper %}
...
<summary>Container won’t start</summary>
...
<summary>Cannot connect to a container’s exposed port</summary>
...
<summary>Container is running but not responding</summary>
...
<summary>Network connectivity issues between containers</summary>
